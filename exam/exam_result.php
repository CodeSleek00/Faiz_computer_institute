...
$student_exam_id = intval($_GET['id']);
$exam_attempt = $conn->query("
    SELECT se.*, e.exam_name, e.marks_per_question 
...
$answers = $conn->query("
    SELECT sa.*, q.question_text, q.option_a, q.option_b, q.option_c, q.option_d, q.correct_option 
