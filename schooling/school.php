...
<head>
    ...
    <link rel="stylesheet" href="schooling.css?v=12">
...
<body>
        ...
        <div class="nav-center">
            ...
            <div class="dropdown" id="dropdownMenu">
                <div class="dropdown-column">
                    <h4>Explore </h4>
                    <a href="../index.php" style="text-decoration: none;"><i class="fas fa-code"></i> Computer Courses</a>
                <a href="university.php"><i class="fas fa-paint-brush"></i> University Courses</a>
    ...
    <div class="content">
      <div class="text-section">
        <h1>Expert guidance,<br> tailored solution</h1>
        <p>
        ...
        <div class="buttons">
          ...
          <button class="secondary">Free trial</button>
        </div>
      </div>

      <div class="image-section">
        <img src="https://images.unsplash.com/photo-1596495577886-d920f1fb7238?auto=format&fit=crop&w=900&q=80" alt="Business Discussion">
    ...
    <div class="stats">
      ...
      <div class="stat">
        <h2 data-target="10">0m</h2>
        <p>Highly efficient financial strategies</p>
      </div>
      <div class="stat">
        <h2 data-target="50">0m</h2>
        <p>Users worldwide, providing them with</p>
      </div>
    </div>
  </div>

    <script src="schooling.js"></script>
